...
const AppointmentsPage: React.FC<AppointmentsPageProps> = ({ 
  stores, onClose, onViewDetails, isAdmin = true, authenticatedUser, 
  onOptimisticUpdate, onEditStore, onRefresh, onOpenMobileMenu 
}) => {
  ...
  return (
    <div className="bg-[#F7F8FA] dark:bg-slate-900 min-h-screen animate-in fade-in duration-500 flex flex-col">
      <header className="lg:hidden sticky top-0 z-50 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg font-bold text-slate-900 dark:text-white">Rendez-vous</h1>
          </div>
      ...
      <div className="flex-1 p-4 md:p-8 space-y-8 overflow-y-auto">
        ...
        <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col md:flex-row gap-3 items-center">
